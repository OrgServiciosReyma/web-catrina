            ...
            <div class="col-md-8 text-end">
                <ul class="list-inline">
                    <li class="list-inline-item">
                        <img height="60" class="me-4" src="{{ asset('img/logo-header-1.png') }}" alt="logo tesoros de méxico">
                    </li>
                    <li class="list-inline-item">
                        <img height="60" class="me-4" src="{{ asset('img/logo-header-2.png') }}" alt="logo gastro & resorts">
                    </li>
                    <li class="list-inline-item">
                        <img height="60" class="me-4" src="{{ asset('img/logo-header-3.png') }}" alt="logo gastro & resorts">
                    </li>
                    <li class="list-inline-item">
                        <img height="60" class="me-4" src="{{ asset('img/logo-header-4.png') }}" alt="logo gastro & resorts">
                    </li>
                    <li class="list-inline-item">
                        <img height="60" class="me-4" src="{{ asset('img/logo-header-5.png') }}" alt="logo gastro & resorts">
                    </li>
                    <li class="list-inline-item">
                        <img height="60" class="me-4" src="{{ asset('img/logo-header-6.png') }}" alt="logo gastro & resorts">
                    </li>
                </ul>
            </div>
        </div>
